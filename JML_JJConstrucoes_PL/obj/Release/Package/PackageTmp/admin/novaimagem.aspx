            ...
            <td colspan="3" style="text-align: center">
                <asp:Panel ID="Panel2" runat="server" style="background-color: #505050" >
                    <table class="auto-style8">
                        ...
                        <tr>
                            <td class="auto-style26" colspan="3">Nome da Imagem:</td>
                        </tr>
                        <tr>
                            <td colspan="3">
                                <asp:TextBox ID="txtTituloImagem" runat="server" CssClass="auto-style17" MaxLength="40" Width="200px"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
